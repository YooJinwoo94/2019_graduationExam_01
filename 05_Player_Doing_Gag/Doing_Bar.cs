...
public class Doing_Bar : MonoBehaviour {

    public UIPanel Doing_Bar_Panel;
    public UISprite Doing_Bar_Sprite;

    public Grow_Up_Button_01 button_01;
    public Grow_Up_Button_02 button_02;
    public Grow_Up_Button_03 button_03;
    public Grow_Up_Button_04 button_04;
   ...
   public void Doing_Sprite_Fill_Up()
    ...
    IEnumerator Sprite_Fill_Up ()
    {
        ...
        {
            Sound_Man_Script.Play_Box_End_Doing_Bar_01();
