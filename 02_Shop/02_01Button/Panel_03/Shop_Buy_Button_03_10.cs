...
public class Shop_Buy_Button_03_10 : MonoBehaviour {
    ...
    /////////////////////////////////////////////////////////채소 타입
    // C_1타입의 가격 
    public int Unit_C_01_Price = 5000;

    // 이 버튼은 C_1 타입의 아이를 생성하기 위한 버튼입니다. 
    private string Button_01_Type = "J_01_Idle_01";
    private string Bg_01 = "Box_BG_04";



    private void Start()
    {
        Unit_C_01_Price = 5000;
    ...
    public void Press_Button_Cha_Open_()
    {
        ...
        // 채소방으로 이동
        Box_Change_Man_Script.Change_Room_To_Alt_Room_03();
