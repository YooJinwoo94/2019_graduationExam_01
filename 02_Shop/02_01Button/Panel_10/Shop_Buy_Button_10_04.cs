...
public class Shop_Buy_Button_10_04 : MonoBehaviour {
    ...
    // D_1타입의 가격 
    public int Unit_Price = 4000;

    // 이 버튼은 C_1 타입의 아이를 생성하기 위한 버튼입니다. 
    private string Button_01_Type = "D_01_Idle_01";
    private string Bg_01 = "Box_BG_02";
    ...
    public void Press_Button_Cha_Open_()
    {
        ...
        _UI_Sprite_Animation.framesPerSecond = 8;

        // 박스 변신 
        //박스 콜라이더 해제.
        Box_Change_Man_Script.Room_Collider_Off_10();

        Box_Change_Man_Script.Change_Room_To_Meat_Room_10();
