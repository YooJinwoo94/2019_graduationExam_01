...
public class Frige_Button_Con_01 : MonoBehaviour
{
    ...
    {
        //사운드
        Sound_Man_Script.Loop_Play_Frige_Loading_BGM_01();

        Fridge_Man_Script.Freeze_Ani_01();
...
public void Time_Count_For_Escape()
    ...
    //  쓰레기가 도망갈때 초기화 
    public void Reset_Panel_Sprite_01()
    {
        Fridge_Man_Script.Ani_Enabled_False_01();
        Fridge_Man_Script.Fridge_Sprite_01.spriteName = "None";
        Fridge_Man_Script.Fridge_Cha_Panel_01.alpha = 0f;
    ...
    IEnumerator Move_Frige_Gage_Bar()
    {
        if (Time_Flow_Counter == 30)
        {
            ...
            Fridge_Man_Script.Normal_Ani_01();
