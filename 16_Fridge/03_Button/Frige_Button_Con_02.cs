...
public class Frige_Button_Con_02 : MonoBehaviour {
    ...
    {
        //사운드
        Sound_Man_Script.Loop_Play_Frige_Loading_BGM_02();

        Fridge_Man_Script.Freeze_Ani_02();
    ...
    {
        Fridge_Man_Script.Ani_Enabled_False_02();
        Fridge_Man_Script.Fridge_Sprite_02.spriteName = "None";
        Fridge_Man_Script.Fridge_Cha_Panel_02.alpha = 0f;
    ...
    IEnumerator Move_Frige_Gage_Bar()
    {
        if (Time_Flow_Counter == 30)
        {
            ...
            Fridge_Man_Script.Normal_Ani_02();
