...
public class Give_Food_To_Customer_Controller_04 : MonoBehaviour {
    ...
    public UIPanel Order_Panel_04;
    public UIPanel Detail_Order_Panel_04;
    ...
    public void Check_Food_Check_04()
    {
        //성공
        if (Food_Fin_04 == true)
        {
            ...
            // 해당 panel 알파값 조절
            Order_Panel_04.alpha = 0;
            Detail_Order_Panel_04.alpha = 0;

            Order_Food_Man_Script.Payed_04 = true;
    ...
    public void Check_IS_Food_Finished_04()
    {
        // 4번째 래시피의 요리 타입을 검색한다.
        _Give_Food_To_Customer_Man.Check_Type_04();
