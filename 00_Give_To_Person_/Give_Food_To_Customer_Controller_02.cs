...
public class Give_Food_To_Customer_Controller_02 : MonoBehaviour {
    ...
    public UIPanel Order_Panel_02;
    public UIPanel Detail_Order_Panel_02;
    ...
    public bool Food_Fin_02;




    public void Check_Food_Check_02()
    {
        //성공
        if (Food_Fin_02 == true)
        {
            ...
            // 해당 panel 알파값 조절
            Order_Panel_02.alpha = 0;
            Detail_Order_Panel_02.alpha = 0;

            Order_Food_Man_Script.Payed_02 = true;
    ...
    public void Check_IS_Food_Finished_02()
    {
        // 2번째 래시피의 요리 타입을 검색한다.
        _Give_Food_To_Customer_Man.Check_Type_02();
