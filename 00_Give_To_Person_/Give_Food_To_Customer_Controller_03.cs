...
public class Give_Food_To_Customer_Controller_03 : MonoBehaviour {
    ...
    public UIPanel Order_Panel_03;
    public UIPanel Detail_Order_Panel_03;
    ...
    public bool Food_Fin_03;

        


    public void Check_Food_Check_03()
    {
        //성공
        if (Food_Fin_03 == true)
        {
            ...
            // 해당 panel 알파값 조절
            Order_Panel_03.alpha = 0;
            Detail_Order_Panel_03.alpha = 0;

            Order_Food_Man_Script.Payed_03 = true;
    ...
    public void Check_IS_Food_Finished_03()
    {
        // 3번째 래시피의 요리 타입을 검색한다.
        _Give_Food_To_Customer_Man.Check_Type_03();
