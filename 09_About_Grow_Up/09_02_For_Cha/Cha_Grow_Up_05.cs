...
public class Cha_Grow_Up_05 : MonoBehaviour {
    ...
    public Trash_Go_Home_Button_05 Trash_Go_Home_Button_Script;
    ...
    public void is_Cha_Trash()
    {
        if (Cha_Stress_Bar_Float >= 1)
        {
            ...
            // 사운드 
            Sound_Man_Script.Play_Box_Cha_IS_Trash_05();
            Sound_Man_Script.Loof_Play_Box_Cha_IS_Trash_05();
    ...
    public void is_Cha_Can_Change()
    {
        if (_Type_Of_Cha == Cha_Type.Like_A)
        {
            if (Cha_Happy_Bar_Float < 0.5f)
            {
                ...
                // 사운드 
                Sound_Man_Script.Play_Evo_Cha_05();
                Sound_Man_Script.Loof_Play_Box_Cha_IS_Idle_05();
            }
            ...
            if (Cha_Happy_Bar_Float >= 1)
            {
                ...
                Particle_Man_Script.Full_Level_Up_Particle[4].Play(true);
    ...
    public void Reset_Float()
    {
        ...
        Box_Change_Man_Script.Room_Reset_05();
    ...
    IEnumerator IS_Trash_Gone_Count_Down_()
    {
        ...
        if (Trash_Go_Home_Button_Script.is_Button_Hit == false)
        {
            ...
            if (Time_Flow_Counter == 0)
            {
                ...
                {
                    Box_Change_Man_Script.Room_Siren_Ani_Vegetable_Room_05();
                }
                // 고기 방
            ...
            if (Time_Flow_Counter == 10)
            {
                ...
                Trash_Button_Off();
                Sound_Man_Script.Loof_Stop_Box_Cha_IS_Trash_05();

                Stop_Box_And_Reset();
                // 채소 방 
                if (Type_A || Type_B || Type_C == true)
                {
                    Box_Change_Man_Script.Room_Shelter_Vegetable_05();
                ...
                if (Type_D || Type_E == true)
                {
                    Box_Change_Man_Script.Room_Shelter_Meat_05();
                }
                // 해산물 방
                if (Type_F || Type_G || Type_H == true)
                {
                    Box_Change_Man_Script.Room_Shelter_Ocean_05();
                }
                // 기타 방 
                if (Type_I || Type_J == true)
                {
                    Box_Change_Man_Script.Room_Shelter_Alt_05();
                }
