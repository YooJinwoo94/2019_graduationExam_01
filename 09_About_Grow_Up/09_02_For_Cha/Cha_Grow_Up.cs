...
public class Cha_Grow_Up : MonoBehaviour {
    ...
    public Trash_Go_Home_Button_01 Trash_Go_Home_Button_Script;
    ...
    public void is_Cha_Trash()
    {
        if(Cha_Stress_Bar_Float >= 1)
        {
            ...
            is_Cha_Trash_Click();
            // 사운드 
            Sound_Man_Script.Play_Box_Cha_IS_Trash_01();
            Sound_Man_Script.Loof_Play_Box_Cha_IS_Trash_01();
    ...
    public void is_Cha_Can_Change()
    {
        if (_Type_Of_Cha == Cha_Type.Like_A)
        {
             if (Cha_Happy_Bar_Float < 0.5f)
            {
                ...
                // 사운드 
                Sound_Man_Script.Play_Evo_Cha_01();
                Sound_Man_Script.Loof_Play_Box_Cha_IS_Idle_01();
            }
             ...
             if (Cha_Happy_Bar_Float >= 1)
            {
                ...
                Particle_Man_Script.Full_Level_Up_Particle[0].Play(true);
            }
    ...
    public void Reset_Float()
    {
        ...
        Box_Change_Man_Script.Room_Reset_01();
        ...
        if (Trash_Go_Home_Button_Script.is_Button_Hit == false)
        {
            ...
            if (Time_Flow_Counter == 0)
            {
               ...
               if (Type_A|| Type_B || Type_C == true)
                {
                    Box_Change_Man_Script.Room_Siren_Ani_Vegetable_Room_01();
                }
               // 고기 방
            ...
            if (Time_Flow_Counter == 10)
            {
                ...
                if (Type_A || Type_B || Type_C == true)
                {
                    Box_Change_Man_Script.Room_Shelter_Vegetable_01();
                ...
                if (Type_D || Type_E == true)
                {
                    Box_Change_Man_Script.Room_Shelter_Meat_01();
                }
                // 해산물 방
                if (Type_F || Type_G || Type_H == true)
                {
                    Box_Change_Man_Script.Room_Shelter_Ocean_01();
                }
                // 기타 방 
                if (Type_I || Type_J == true)
                {
                    Box_Change_Man_Script.Room_Shelter_Alt_01();
                }
