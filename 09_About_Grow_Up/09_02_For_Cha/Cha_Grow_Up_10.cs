...
public class Cha_Grow_Up_10 : MonoBehaviour {
    ...
    public Trash_Go_Home_Button_10 Trash_Go_Home_Button_Script;
    ...
    public void is_Cha_Trash()
    {
        if (Cha_Stress_Bar_Float >= 1)
        {
            ...
            // 사운드 
            Sound_Man_Script.Play_Box_Cha_IS_Trash_10();
            Sound_Man_Script.Loof_Play_Box_Cha_IS_Trash_10();
    ...
    public void is_Cha_Can_Change()
    {
        ...
        if (_Type_Of_Cha == Cha_Type.Like_A)
        {
            ...
            if (Cha_Happy_Bar_Float < 0.5f)
            {
                ...
                // 사운드 
                Sound_Man_Script.Play_Evo_Cha_10();
                Sound_Man_Script.Loof_Play_Box_Cha_IS_Idle_10();
            }
            ...
            if (Cha_Happy_Bar_Float >= 1)
            {
                ...
                Particle_Man_Script.Full_Level_Up_Particle[9].Play(true);
        ...
        if (_Type_Of_Cha == Cha_Type.Like_F)
        {
            if (Cha_Happy_Bar_Float < 0.5f)
            {
                _UI_Sprite_Animation.namePrefix = "F_01_Idle_";
                _UI_Sprite_Animation.framesPerSecond = 10;
            ...
            if (Cha_Happy_Bar_Float >= 0.5f && Cha_Happy_Bar_Float < 1)
            {
                _UI_Sprite_Animation.namePrefix = "F_02_Idle_";
                _UI_Sprite_Animation.framesPerSecond = 10;
            ...
            if (Cha_Happy_Bar_Float >= 1)
            {
                _UI_Sprite_Animation.namePrefix = "F_03_Idle_";
                _UI_Sprite_Animation.framesPerSecond = 10;
    ...
    public void Reset_Float()
    {
        ...
        Box_Change_Man_Script.Room_Reset_10();
    ...
    IEnumerator IS_Trash_Gone_Count_Down_()
    {
        ...
        if (Trash_Go_Home_Button_Script.is_Button_Hit == false)
        {
            ...
            if (Time_Flow_Counter == 0)
            {
                ...
                {
                    Box_Change_Man_Script.Room_Siren_Ani_Vegetable_Room_10();
                }
                // 고기 방
            ...
            if (Time_Flow_Counter == 10)
            {
              ...
              //  Reset_Float();
                ...
                Sound_Man_Script.Loof_Stop_Box_Cha_IS_Trash_10();

                Stop_Box_And_Reset();
                // 채소 방 
                if (Type_A || Type_B || Type_C == true)
                {
                    Box_Change_Man_Script.Room_Shelter_Vegetable_10();
                ...
                if (Type_D || Type_E == true)
                {
                    Box_Change_Man_Script.Room_Shelter_Meat_10();
                }
                // 해산물 방
                if (Type_F || Type_G || Type_H == true)
                {
                    Box_Change_Man_Script.Room_Shelter_Ocean_10();
                }
                // 기타 방 
                if (Type_I || Type_J == true)
                {
                    Box_Change_Man_Script.Room_Shelter_Alt_10();
                }
