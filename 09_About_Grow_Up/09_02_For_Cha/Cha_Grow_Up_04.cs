...
public class Cha_Grow_Up_04 : MonoBehaviour
{
    public UISprite Cha;
    ...
    public Trash_Go_Home_Button_04 Trash_Go_Home_Button_Script;

    public UISprite Happy_Bar_Sprite_01;
    public UISprite Stress_Bar_Sprite_01;

    public UIButton _Cha_01_Change_Normal_Image;

    public UISpriteAnimation _UI_Sprite_Animation;

    public ParticleSystem Dust;
    public GameObject Debuff;
    // public Particle_Manager[] Paticle;
    ...
    private void Awake()
    {
        ...
        /*
        var Pig = Paticle[0].GetComponent<ParticleSystem>().main;
        Pig.e
        */
    }
    ...
    public void is_Cha_Trash()
    {
        if (Cha_Stress_Bar_Float >= 1)
        {
            ...
            // 사운드 
            Sound_Man_Script.Play_Box_Cha_IS_Trash_04();
            Sound_Man_Script.Loof_Play_Box_Cha_IS_Trash_04();
    ...
    public void is_Cha_Can_Change()
    {
        ...
        if (_Type_Of_Cha == Cha_Type.Like_A)
        {
            if (Cha_Happy_Bar_Float < 0.5f)
            {
                if (Cha.spriteName != "A_01_Idle_01")
                {
                    Cha.spriteName = "A_01_Idle_01";
                }
                _UI_Sprite_Animation.namePrefix = "A_01_Idle_";
                _UI_Sprite_Animation.framesPerSecond = 10;

                // 사운드 
                Sound_Man_Script.Play_Evo_Cha_04();
                Sound_Man_Script.Loof_Play_Box_Cha_IS_Idle_04();
            }

            if (Cha_Happy_Bar_Float >= 0.5f && Cha_Happy_Bar_Float < 1)
            {
                if (Cha.spriteName != "A_02_Idle_01")
                {
                    _Cha_01_Change_Normal_Image.normalSprite = "A_02_Idle_01";

                    Cha.spriteName = "A_02_Idle_01";
                }
            ...
            {
                if (Cha.spriteName != "A_03_Idle_01")
                {
                    _Cha_01_Change_Normal_Image.normalSprite = "A_03_Idle_01";

                    Cha.spriteName = "A_03_Idle_01";
                }
                _UI_Sprite_Animation.namePrefix = "A_03_Idle_";
                _UI_Sprite_Animation.framesPerSecond = 10;

                Particle_Man_Script.Full_Level_Up_Particle[3].Play(true);
    ...
    public void Reset_Float()
    {
        ...
        Box_Change_Man_Script.Room_Reset_04();
    ...
    IEnumerator IS_Trash_Gone_Count_Down_()
    {
        ...
        if (Trash_Go_Home_Button_Script.is_Button_Hit == false)
        {
            ...
            if (Time_Flow_Counter == 0)
            {
                ...
                {
                    Box_Change_Man_Script.Room_Siren_Ani_Vegetable_Room_04();
                }
                // 고기 방
            ...
            if (Time_Flow_Counter == 10)
            {
                ...
                Sound_Man_Script.Loof_Stop_Box_Cha_IS_Trash_04();

                Stop_Box_And_Reset();
                // 채소 방 
                if (Type_A || Type_B || Type_C == true)
                {
                    Box_Change_Man_Script.Room_Shelter_Vegetable_04();
                ...
                if (Type_D || Type_E == true)
                {
                    Box_Change_Man_Script.Room_Shelter_Meat_04();
                }
                // 해산물 방
                if (Type_F || Type_G || Type_H == true)
                {
                    Box_Change_Man_Script.Room_Shelter_Ocean_04();
                }
                // 기타 방 
                if (Type_I || Type_J == true)
                {
                    Box_Change_Man_Script.Room_Shelter_Alt_04();
                }
