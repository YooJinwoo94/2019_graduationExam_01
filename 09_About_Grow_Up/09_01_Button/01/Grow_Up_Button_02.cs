...
public class Grow_Up_Button_02 : MonoBehaviour
{
...
//조미료
    ...
    */
    ...
    public void Button_02()
    {
        ...
        Sound_Man_Script.Play_Shower_01();
    ...
    public void Button_02_Staus()
    {
        ...
        else if (_Grow_Up_Script.Cha_Stress_Count <= 1)
        {
            ...
            if (_Grow_Up_Script._Type_Of_Cha == Cha_Type.Like_A)
            {
                ...
                // 보통 파티클
                Particle_Man_Script.Normal_Heart[0].Play(true);
            ...
            else if (_Grow_Up_Script._Type_Of_Cha == Cha_Type.Like_B)
            {
                ...
                // 매우 좋아함 파티클 
                Particle_Man_Script.Hard_Love[0].Play(true);
            ...
            {
                Debug.Log("싫음");
                Particle_Man_Script.Do_Not_Like[0].Play(true);
