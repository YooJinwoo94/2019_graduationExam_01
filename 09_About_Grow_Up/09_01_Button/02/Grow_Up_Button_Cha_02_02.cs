...
public class Grow_Up_Button_Cha_02_02 : MonoBehaviour {

    public Cha_Grow_Up_02 _Grow_Up_Script;

    public UIButton _Button_02;

    public UISprite Happy_Bar_Sprite;
    public UISprite Stress_Bar_Sprite;

    public Doing_Bar_02_00 Doing_Bar_Script;
    ...
    public Check_Cha_Type_02 Check_Cha_Type_Ani;
...
//조미료
    ...
    */
    ...
    public void Button_02()
    {
        ...
        // 내가 보냈어!
        Doing_Bar_Script.Is_Button_02 = true;
        ...
        Sound_Man_Script.Play_Shower_02();
    ...
    public void Button_02_Staus()
    {
        ...
        else if (_Grow_Up_Script.Cha_Stress_Count <= 1)
        {
            ...
            if (_Grow_Up_Script._Type_Of_Cha == Cha_Type.Like_A)
            {
                ...
                // 보통 파티클
                Particle_Man_Script.Normal_Heart[1].Play(true);
            ...
            else if (_Grow_Up_Script._Type_Of_Cha == Cha_Type.Like_B)
            {
                ...
                // 매우 좋아함 파티클 
                Particle_Man_Script.Hard_Love[1].Play(true);
            ...
            {
                Debug.Log("싫음");
                Particle_Man_Script.Do_Not_Like[1].Play(true);
